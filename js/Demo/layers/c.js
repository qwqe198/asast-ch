...
addLayer("c", {
        ...
        challenges: {
		    ...
		    11: {
                ...
                goalDescription: 'Have HH1.254 points I guess',
                canComplete() {
        ...
        upgrades: {
            ...
            11: {
                ...
                description: "Gain 1J5 Point every second.",
                cost: new Decimal(1),
            ...
            12: {
                ...
                effect() { // Calculate bonuses from the upgrade. Can return a single value or an object with multiple values
                    let ret = player[this.layer].points.add(1).pow(player[this.layer].upgrades.includes(24)?1.1:(player[this.layer].upgrades.includes(14)?1.5:1)) 
        ...
        buyables: {
            ...
            11: {
                ...
                display() { // Everything else displayed in the buyable button after the title
                    ...
                    return "Cost: " + format(this.cost()) + " lollipops\n\
